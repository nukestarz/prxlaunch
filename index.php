...
<!-- Mirrored from demo.highhay.com/creation/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jun 2020 08:15:09 GMT -->
<head>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<meta charset="utf-8">

	<!-- Page Title Here -->
	<title>Paradox RP Launcher</title>
...
<!--	<link rel="stylesheet" href="./css/style-color1.css">-->
    ...
    <script>
        ...
        $.ajax({
            url:'https://theparadox.city/status.php',
            type:'GET', 
	...
	<header class="header-top">
		<div class="logo-wrapper">
			<h2 class="logo">
					...
					<span class="title">PARADOX LEGACY V3</span>
				</h2>
		</div>
		...
		<ul id="qmenu" class="qmenu">
			<li data-menuanchor="home">
				<a href="#home">
					...
					<span class="title">Play Paradox V3</span>
				</a>
			</li>
			<li data-menuanchor="about-us">
				<a href="#about-us">
					<i class="icon lnr lnr-flag"></i>
					<span class="title">Buy Coins</span>
				</a>
			</li>
...
<!--							<i class="icon lnr lnr-clock anim-zoomin"></i>-->
					...
					<div class="c-clock clock clock-countdown">
						...
						<div class="img-middle bg-img" data-image-src="img/bg-sample1.jpg">
							<div class="tile-days">
								<span class=""><div id="thisdiv"></div></span>
								<span class="txt">Players Online</span>
							</div>
				...
				<div class="c-right">
					<div class="anim-slideright">
						<header class="header">
							<h2>Paradox <strong>V3</strong></h2>
							<h3>An awesome new company.</h3>
						</header>
						<div class="desc">
									<p>Paradox Legacy V3 will be available here soon.</p>
							</div>
						<div class="btns">
							<a class="btn" href="fivem://131.153.76.90:30110">Play Paradox RP</a>
						</div>
					</div>
				</div>
			</section>
...
<!--							<div class="img-bottom"></div>-->
	...
	<footer class="site-footer">
		<div class="note">
			<p>&copy; Copyright Nefarious 2020</p>
		</div>
	</footer>
	<!-- END OF site footer -->
...
<!-- Mirrored from demo.highhay.com/creation/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jun 2020 08:15:35 GMT -->
</html>